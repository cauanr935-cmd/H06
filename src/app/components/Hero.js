...
export default function Hero({ signHref }) {
  return (
    <section className={styles.hero}>
      <h1>Sua terra pode gerar renda com as árvores em pé.</h1>
      <p>
        A Hectare06 conecta produtores rurais ao mercado voluntário de crédito de carbono. Assine a carta de intenção para demonstrar seu
